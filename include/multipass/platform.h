...
public:
    ...
    // OS file calls
    virtual std::ptrdiff_t pread(int fd, void* buffer, size_t bytes_to_read, off_t offset) const;
    virtual std::ptrdiff_t pwrite(int fd, void* buffer, size_t bytes_to_write, off_t offset) const;
